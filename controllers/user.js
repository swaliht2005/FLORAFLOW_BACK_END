...
try {
  ...
  console.log('User model loaded successfully in userController');
} catch (err) {
  console.error('Failed to load User model in userController:', err.message);
  throw new Error('User model not found. Check models/User.js');
}
